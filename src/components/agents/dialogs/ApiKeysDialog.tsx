            ...
            <div key="add-edit-form" className="space-y-4 p-4 bg-[#0c0b13] rounded-md">
                    ...
                    <SelectContent className="bg-[#222] border-[#444] text-white z-[999]">
                      {availableModelProviders.map((provider) => (
                        <SelectItem
                          ...
                          className="data-[selected]:bg-[#0c0b13] data-[highlighted]:bg-[#0c0b13] !text-white focus:!text-white hover:text-electric data-[selected]:!text-electric"
                        >
                          {provider.label}
                        </SelectItem>
                      ))}
                  ...
                  <div className="grid grid-cols-4 items-center gap-4">
                    ...
                    <div className="col-span-3 flex items-center">
                      <Checkbox
                        ...
                        className="mr-2 data-[state=checked]:bg-electext-electric data-[state=checked]:border-electext-electric"
                      />
              ...
              <DialogFooter key="form-footer" className="flex justify-end gap-2 mt-4">
                ...
                <Button
                  ...
                  className="bg-electext-electric text-black hover:bg-[#00cc7d]"
                  disabled={isLoading}
                >
                  {isLoading && (
            ...
            <div key="api-key-list-content"> {/* Chave única para este bloco */}
              ...
              {isLoading ? (
                <div className="flex items-center justify-center h-40">
                  <div className="animate-spin rounded-full h-8 w-8 border-t-2 border-b-2 border-electext-electric"></div>
                </div>
              ) : apiKeys.length > 0 ? (
                <div className="space-y-2">
                  {apiKeys.map((apiKey) => (
                    <div
                      ...
                      className="flex items-center justify-between p-3 bg-[#222] rounded-md border border-[#0c0b13] hover:border-electext-electric/30"
                    >
                      <div>
                        ...
                        <div className="flex items-center gap-2 mt-1">
                          <Badge
                            variant="outline"
                            className="bg-[#0c0b13] text-electric border-electext-electric/30"
                          >
                      ...
                      <div className="flex gap-2">
                        ...
                        <Button
                          ...
                          className="text-gray-300 hover:text-electric hover:bg-[#0c0b13]"
                ...
                <div className="text-center py-10 border border-dashed border-[#0c0b13] rounded-md bg-[#222] text-gray-400">
                  ...
                  <Button
                    onClick={handleAddClick}
                    className="mt-4 bg-[#0c0b13] text-electric hover:bg-[#444]"
                  >
                    <Plus className="mr-2 h-4 w-4" />
                    Add Key
                  </Button>
        ...
        {!isAddingApiKey && (
          <DialogFooter key="close-footer" className="border-t border-[#0c0b13] pt-4">
            <Button
              ...
              className="bg-shock-dark/35 border-shock-dark/35 text-gray-300 hover:bg-shock-dark/40 hover:text-white"
            >
              Fechar
            </Button>
          </DialogFooter>
