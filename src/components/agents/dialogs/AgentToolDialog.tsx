// src/components/agents/dialogs/AgentToolDialog.tsx
            ...
            {filteredAgents.map((agent) => (
              <button
                ...
                className={cn(
                  ...
                  selectedAgentId === agent.id && "border-[#CB39C1] bg-[#1a1a1a] shadow-md"
                )}
              >
                ...
                {selectedAgentId === agent.id && (
                  <span className="ml-2 text-[#CB39C1] font-bold">Selected</span>
                )}
              </button>
            ))}
          </div>
