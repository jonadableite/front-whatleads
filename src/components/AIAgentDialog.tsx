// src/components/AIAgentDialog.tsx
...
export function AIAgentDialog({
  ...
  const loadAvailableAgents = useCallback(async () => {
    ...
    try {
      ...
      const response = await getInstanceEvoAIs(instanceName);
  ...
  const handleAgentSelection = useCallback(
    (agentId: string) => {
      ...
      if (agent) {
        ...
        const agentUrl = `${process.env.NEXT_PUBLIC_API_URL}/api/v1/a2a/${agentId}`;
        setFormData((prev) => ({
          ...prev,
          agentUrl,
  ...
  const saveAgent = useCallback(async () => {
    ...
    try {
      ...
      if (selectedAgent && selectedAgent.id) {
        ...
        await updateEvoAI(selectedAgent.id, instanceName, agentData);
        toast({
          title: "Sucesso",
        ...
        // Criar novo agente
        await createEvoAI(instanceName, agentData);
        toast({
          title: "Sucesso",
  ...
  const deleteAgent = useCallback(
    async (agentId: string) => {
      ...
      setLoading(true);
      try {
        await deleteEvoAI(agentId, instanceName);
        toast({
          title: "Sucesso",
          ...
          {!isFormVisible && (
            <div className="p-6 h-full flex flex-col">
              <div className="flex justify-between items-center mb-4 flex-shrink-0">
                <h3 className="text-lg font-semibold">Agentes Conectados</h3>
                <Button
                      ...
                      <div
                        ...
                        className={cn(
                          ...
                          agent.enabled
                            ...
                            : "border-gray-200 bg-gray-50 dark:border-gray-700 dark:bg-[#16151D]/20",
                        )}
                      >
              ...
              <ScrollArea className="flex-1 px-6 py-4">
                <div className="space-y-6 pr-4">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div>
                      <Label htmlFor="description">Nome do Agente *</Label>
                      <Input
                        id="description"
                  ...
                  {!isEditing && (
                    <div>
                      <div className="flex items-center gap-2 mb-2">
                        <Label htmlFor="agentSelect">Selecionar Agente *</Label>
                  ...
                  <div className="space-y-4 p-4 bg-gray-50 dark:bg-[#16151D]/50 rounded-lg">
                    <h4 className="font-medium">Quando Ativar o Agente</h4>

                    <div>
                      <div className="flex items-center gap-2 mb-2">
                        <Label htmlFor="triggerType">Tipo de Ativação *</Label>
                  ...
                  {/* Comportamentos */}
                  <div className="space-y-4 p-4 bg-gray-50 dark:bg-[#16151D]/50 rounded-lg">
                    <h4 className="font-medium">Comportamentos do Agente</h4>
