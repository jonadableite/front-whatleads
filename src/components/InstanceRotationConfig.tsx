...
> = ({
  ...
  const handleConfigureRotation = async () => {
    ...
    try {
      ...
      await api.main.post(`/campaigns/${campaignId}/instances`, {
        instanceIds,
        useRotation: true,
        rotationStrategy,
  ...
  const handleRemoveRotation = async () => {
    try {
      ...
      await api.main.delete(`/campaigns/${campaignId}/instances`, {
        data: { instanceIds },
      });
  ...
  const handleResetCounters = async () => {
    try {
      await api.main.post(`/campaigns/${campaignId}/instances/reset`);
