...
/**
 * Props para componente SpinTaxEditor
 */
export interface SpinTaxEditorProps {
  ...
  disabled?: boolean;
  /** Configurações do SpinTax */
  config?: SpinTaxConfig;
  /** Callback para validação em tempo real */
  onValidation?: (result: SpinTaxValidationResult) => void;
  /** Mostrar preview em tempo real */
  showPreview?: boolean;
  /** Número de exemplos no preview */
  previewCount?: number;
...
/**
 * Props para componente SpinTaxPreview
 */
export interface SpinTaxPreviewProps {
  /** Texto com SpinTax */
  text: string;
  /** Número de exemplos a mostrar */
  count?: number;
  /** Configurações do SpinTax */
  config?: SpinTaxConfig;
  /** Classe CSS adicional */
  className?: string;
  /** Callback quando exemplos são gerados */
  onExamplesGenerated?: (examples: string[]) => void;
}

/**
 * Props para componente SpinTaxValidator
 */
export interface SpinTaxValidatorProps {
  /** Texto com SpinTax */
  text: string;
  /** Configurações do SpinTax */
  config?: SpinTaxConfig;
...
/**
 * Estado do hook useSpinTax
 */
export interface UseSpinTaxState {
  /** Texto atual */
  text: string;
  /** Resultado da validação */
  validation: SpinTaxValidationResult | null;
  /** Exemplos gerados */
  examples: string[];
  /** Se está processando */
...
/**
 * Retorno do hook useSpinTax
 */
export interface UseSpinTaxReturn extends UseSpinTaxState {
  /** Atualizar texto */
  setText: (text: string) => void;
  /** Gerar exemplos */
  generateExamples: (count?: number) => Promise<void>;
  /** Validar texto */
  validate: () => Promise<void>;
  /** Processar texto */
  process: (count?: number) => Promise<string[]>;
  /** Limpar estado */
  clear: () => void;
}