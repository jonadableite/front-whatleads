          ...
          <div className="mt-4 space-y-4">
            <div className="relative">
              ...
              <Input
                ...
                className="pl-10 bg-neutral-800/40 border-neutral-700/50 text-white focus-visible:ring-blue-500/50 focus-visible:border-blue-500/50 shadow-inner rounded-xl"
              ...
              {isLoading ? (
                ...
                <div className="space-y-2">
                  {filteredAgents.map((agent) => (
                    <div
                      key={agent.id}
                      className="p-3 rounded-md cursor-pointer transition-all bg-neutral-800 hover:bg-neutral-800/90 border border-neutral-700/30 hover:border-blue-500/30 shadow-sm hover:shadow-md group"
                    ...
                    >
                      ...
                      <div className="flex items-center justify-between mt-1">
                        <Badge className="text-xs bg-neutral-800/60 text-blue-400 border border-blue-500/30">
                          {agent.type}
                        </Badge>
                        {agent.model && (
