...
const MessageContainer: React.FC<{ onComplete: () => void }> = ({
  ...
  const [isLastMessageComplete, setIsLastMessageComplete] =
    useState(false);
...
>>>>>>> d515fe1 (pricing)
  ...
  const handleSubscribe = (
    ...
    if (!isPriceValid(priceId)) {
      toast.error(
        `Preço indisponível para o plano ${planName}. Por favor, contate o suporte.`,
      );
      return;
    }
  ...
  useEffect(() => {
    const validatePriceIds = () => {
      ...
      if (missingPrices.length > 0) {
        console.error(
          'Configuração incompleta dos preços:',
          missingPrices,
        );
        toast.error(
          ...
          {!showPlans ? (
            ...
            >
              <div className="text-center mb-16">
                ...
                >
                  Encontre o plano perfeito para impulsionar seu
                  negócio
                </motion.p>
              </div>
                ...
                {plans.map((plan) => (
                  <motion.div
                    ...
                    className={`
                      ...
                      ${
                        plan.recommended
                          ? 'md:scale-105 ring-2 ring-neon-green shadow-lg shadow-neon-green/20'
                          : ''
                      }
                    `}
                  >
